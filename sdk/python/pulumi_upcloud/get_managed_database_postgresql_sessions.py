...
def get_managed_database_postgresql_sessions(limit: Optional[_builtins.int] = None,
...
def get_managed_database_postgresql_sessions_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
