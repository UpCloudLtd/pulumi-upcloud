...
def get_managed_database_mysql_sessions(limit: Optional[builtins.int] = None,
...
def get_managed_database_mysql_sessions_output(limit: Optional[pulumi.Input[Optional[builtins.int]]] = None,
