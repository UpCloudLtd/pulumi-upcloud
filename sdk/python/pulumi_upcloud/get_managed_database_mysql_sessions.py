...
__all__ = [
    'GetManagedDatabaseMysqlSessionsResult',
    'AwaitableGetManagedDatabaseMysqlSessionsResult',
    'get_managed_database_mysql_sessions',
    'get_managed_database_mysql_sessions_output',
]

@pulumi.output_type
class GetManagedDatabaseMysqlSessionsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def sessions(self) -> Sequence['outputs.GetManagedDatabaseMysqlSessionsSessionResult']:
        return pulumi.get(self, "sessions")


class AwaitableGetManagedDatabaseMysqlSessionsResult(GetManagedDatabaseMysqlSessionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagedDatabaseMysqlSessionsResult(
            id=self.id,
            limit=self.limit,
            offset=self.offset,
            order=self.order,
...
def get_managed_database_mysql_sessions(limit: Optional[_builtins.int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('upcloud:index/getManagedDatabaseMysqlSessions:getManagedDatabaseMysqlSessions', __args__, opts=opts, typ=GetManagedDatabaseMysqlSessionsResult).value

    return AwaitableGetManagedDatabaseMysqlSessionsResult(
...
def get_managed_database_mysql_sessions_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                               ...
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetManagedDatabaseMysqlSessionsResult]:
    """
    Current sessions of a MySQL managed database
    ...
    __ret__ = pulumi.runtime.invoke_output('upcloud:index/getManagedDatabaseMysqlSessions:getManagedDatabaseMysqlSessions', __args__, opts=opts, typ=GetManagedDatabaseMysqlSessionsResult)
    return __ret__.apply(lambda __response__: GetManagedDatabaseMysqlSessionsResult(
