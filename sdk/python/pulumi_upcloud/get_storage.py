...
class GetStorageResult:
    ...
    def system_labels(self) -> Mapping[str, _builtins.str]:
...
def get_storage(access_type: Optional[_builtins.str] = None,
...
def get_storage_output(access_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
