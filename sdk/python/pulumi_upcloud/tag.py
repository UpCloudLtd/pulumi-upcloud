...
class TagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Free form text representing the meaning of the tag
        :param pulumi.Input[str] name: The value representing the tag
        :param pulumi.Input[Sequence[pulumi.Input[str]]] servers: A collection of servers that have been assigned the tag
        """
...
class Tag(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            servers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'Tag':
        """
