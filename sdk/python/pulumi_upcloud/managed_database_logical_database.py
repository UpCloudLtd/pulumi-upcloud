...
@pulumi.type_token("upcloud:index/managedDatabaseLogicalDatabase:ManagedDatabaseLogicalDatabase")
class ManagedDatabaseLogicalDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            collation: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            service: Optional[pulumi.Input[_builtins.str]] = None) -> 'ManagedDatabaseLogicalDatabase':
        """
