...
def get_managed_object_storage_policies(service_uuid: Optional[_builtins.str] = None,
...
def get_managed_object_storage_policies_output(service_uuid: Optional[pulumi.Input[_builtins.str]] = None,
