...
class ManagedDatabaseOpensearchArgs:
    def __init__(__self__, *,
                 ...
                 access_control: Optional[pulumi.Input[builtins.bool]] = None,
                 extended_access_control: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] access_control: Enables users access control for OpenSearch service. User access control rules will only be enforced if this attribute
               is enabled.
        :param pulumi.Input[builtins.bool] extended_access_control: Grant access to top-level `_mget`, `_msearch` and `_bulk` APIs. Users are limited to perform operations on indices based
    ...
    def access_control(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def access_control(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "access_control", value)

    @property
    @pulumi.getter(name="extendedAccessControl")
    def extended_access_control(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def extended_access_control(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ManagedDatabaseOpensearch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedDatabaseOpensearch':
        """
    ...
    @property
    @pulumi.getter(name="accessControl")
    def access_control(self) -> pulumi.Output[builtins.bool]:
        """
        Enables users access control for OpenSearch service. User access control rules will only be enforced if this attribute
        is enabled.
        """
    ...
    @property
    @pulumi.getter(name="extendedAccessControl")
    def extended_access_control(self) -> pulumi.Output[builtins.bool]:
        """
        Grant access to top-level `_mget`, `_msearch` and `_bulk` APIs. Users are limited to perform operations on indices based
        on the user-specific access control rules.
        """
