...
class ObjectStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] access_key: The access key used to identify user.
        ...
        :param pulumi.Input[_builtins.str] secret_key: The secret key used to authenticate user.
        ...
        :param pulumi.Input[_builtins.int] size: The size of the object storage instance in gigabytes
        :param pulumi.Input[_builtins.str] zone: The zone in which the object storage instance will be created, e.g. `de-fra1`. You can list available zones with `upctl zone list`.
        :param pulumi.Input[_builtins.str] description: The description of the object storage instance to be created
        :param pulumi.Input[_builtins.str] name: The name of the object storage instance to be created
        """
...
class _ObjectStorageState:
    def __init__(__self__, *,
                 ...
                 used_space: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def used_space(self) -> Optional[pulumi.Input[_builtins.int]]:
        return pulumi.get(self, "used_space")

    @used_space.setter
    def used_space(self, value: Optional[pulumi.Input[_builtins.int]]):
...
@pulumi.type_token("upcloud:index/objectStorage:ObjectStorage")
class ObjectStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url: Optional[pulumi.Input[_builtins.str]] = None,
            used_space: Optional[pulumi.Input[_builtins.int]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'ObjectStorage':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="usedSpace")
    def used_space(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "used_space")
