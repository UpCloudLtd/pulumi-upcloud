...
class _ManagedDatabasePostgresqlState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] sslmode: SSL Connection Mode for PostgreSQL
    ...
    @sslmode.setter
    def sslmode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedDatabasePostgresql(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            zone: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedDatabasePostgresql':
        """
    ...
    @property
    @pulumi.getter
    def sslmode(self) -> pulumi.Output[builtins.str]:
        """
        SSL Connection Mode for PostgreSQL
        """
        return pulumi.get(self, "sslmode")
