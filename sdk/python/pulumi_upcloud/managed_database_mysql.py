...
__all__ = ['ManagedDatabaseMysqlArgs', 'ManagedDatabaseMysql']

@pulumi.input_type
class ManagedDatabaseMysqlArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNetworkArgs']]]]:
        """
    ...
    @networks.setter
    def networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNetworkArgs']]]]):
...
class _ManagedDatabaseMysqlState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNetworkArgs']]]] = None,
                 node_states: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNodeStateArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the service. The name is used as a prefix for the logical hostname. Must be unique within an account
        :param pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNetworkArgs']]] networks: Private networks attached to the managed database
        :param pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNodeStateArgs']]] node_states: Information about nodes providing the managed service
        :param pulumi.Input[_builtins.str] plan: Service plan to use. This determines how much resources the instance will have. You can list available plans with `upctl database plans <type>`.
        :param pulumi.Input[_builtins.bool] powered: The administrative power state of the service
    ...
    @_builtins.property
    @pulumi.getter
    def components(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlComponentArgs']]]]:
        """
    ...
    def node_states(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNodeStateArgs']]]]:
        """
    ...
    @node_states.setter
    def node_states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseMysqlNodeStateArgs']]]]):
...
@pulumi.type_token("upcloud:index/managedDatabaseMysql:ManagedDatabaseMysql")
class ManagedDatabaseMysql(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ManagedDatabaseMysqlArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ManagedDatabaseMysqlArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        super(ManagedDatabaseMysql, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'ManagedDatabaseMysql':
        """
        ...
        __props__.__dict__["zone"] = zone
        return ManagedDatabaseMysql(resource_name, opts=opts, __props__=__props__)

    @_builtins.property
    @pulumi.getter
    def components(self) -> pulumi.Output[Sequence['outputs.ManagedDatabaseMysqlComponent']]:
        """
        Service component information
        """
        return pulumi.get(self, "components")
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> pulumi.Output[Optional[Sequence['outputs.ManagedDatabaseMysqlNetwork']]]:
        """
        Private networks attached to the managed database
        """
        return pulumi.get(self, "networks")
    ...
    @_builtins.property
    @pulumi.getter(name="nodeStates")
    def node_states(self) -> pulumi.Output[Sequence['outputs.ManagedDatabaseMysqlNodeState']]:
        """
        Information about nodes providing the managed service
        """
        return pulumi.get(self, "node_states")
