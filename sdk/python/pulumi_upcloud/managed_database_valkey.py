...
__all__ = ['ManagedDatabaseValkeyArgs', 'ManagedDatabaseValkey']

@pulumi.input_type
class ManagedDatabaseValkeyArgs:
    def __init__(__self__, *,
                 ...
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNetworkArgs']]]] = None,
                 powered: Optional[pulumi.Input[_builtins.bool]] = None,
                 properties: Optional[pulumi.Input['ManagedDatabaseValkeyPropertiesArgs']] = None,
                 termination_protection: Optional[pulumi.Input[_builtins.bool]] = None):
        """
        The set of arguments for constructing a ManagedDatabaseValkey resource.
        :param pulumi.Input[_builtins.str] plan: Service plan to use. This determines how much resources the instance will have. You can list available plans with `upctl database plans valkey`.
        ...
        :param pulumi.Input[_builtins.int] additional_disk_space_gib: Not supported for `valkey` databases. Should be left unconfigured.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNetworkArgs']]] networks: Private networks attached to the managed database
        :param pulumi.Input[_builtins.bool] powered: The administrative power state of the service
        :param pulumi.Input['ManagedDatabaseValkeyPropertiesArgs'] properties: Database Engine properties for Valkey
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNetworkArgs']]]]:
        """
    ...
    @networks.setter
    def networks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNetworkArgs']]]]):
    ...
    @powered.setter
    def powered(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "powered", value)

    @_builtins.property
    @pulumi.getter
    def properties(self) -> Optional[pulumi.Input['ManagedDatabaseValkeyPropertiesArgs']]:
        """
    ...
    @properties.setter
    def properties(self, value: Optional[pulumi.Input['ManagedDatabaseValkeyPropertiesArgs']]):
...
@pulumi.input_type
class _ManagedDatabaseValkeyState:
    def __init__(__self__, *,
                 additional_disk_space_gib: Optional[pulumi.Input[_builtins.int]] = None,
                 components: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyComponentArgs']]]] = None,
                 labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 maintenance_window_dow: Optional[pulumi.Input[_builtins.str]] = None,
                 maintenance_window_time: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNetworkArgs']]]] = None,
                 node_states: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNodeStateArgs']]]] = None,
                 ...
                 service_port: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.int] additional_disk_space_gib: Not supported for `valkey` databases. Should be left unconfigured.
        :param pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyComponentArgs']]] components: Service component information
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: User defined key-value pairs to classify the managed database.
        :param pulumi.Input[_builtins.str] maintenance_window_dow: Maintenance window day of week. Lower case weekday name (monday, tuesday, ...)
        :param pulumi.Input[_builtins.str] maintenance_window_time: Maintenance window UTC time in hh:mm:ss format
        :param pulumi.Input[_builtins.str] name: Name of the service. The name is used as a prefix for the logical hostname. Must be unique within an account
        :param pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNetworkArgs']]] networks: Private networks attached to the managed database
        :param pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNodeStateArgs']]] node_states: Information about nodes providing the managed service
        :param pulumi.Input[_builtins.str] plan: Service plan to use. This determines how much resources the instance will have. You can list available plans with `upctl database plans valkey`.
        :param pulumi.Input[_builtins.bool] powered: The administrative power state of the service
    ...
    @_builtins.property
    @pulumi.getter
    def components(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyComponentArgs']]]]:
        """
    ...
    @components.setter
    def components(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyComponentArgs']]]]):
    ...
    def node_states(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNodeStateArgs']]]]:
        """
    ...
    @node_states.setter
    def node_states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedDatabaseValkeyNodeStateArgs']]]]):
    ...
    def primary_database(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def primary_database(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def service_port(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @service_port.setter
    def service_port(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("upcloud:index/managedDatabaseValkey:ManagedDatabaseValkey")
class ManagedDatabaseValkey(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 maintenance_window_time: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyNetworkArgs', 'ManagedDatabaseValkeyNetworkArgsDict']]]]] = None,
                 plan: Optional[pulumi.Input[_builtins.str]] = None,
                 powered: Optional[pulumi.Input[_builtins.bool]] = None,
                 properties: Optional[pulumi.Input[Union['ManagedDatabaseValkeyPropertiesArgs', 'ManagedDatabaseValkeyPropertiesArgsDict']]] = None,
                 termination_protection: Optional[pulumi.Input[_builtins.bool]] = None,
                 title: Optional[pulumi.Input[_builtins.str]] = None,
                 zone: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.str] maintenance_window_time: Maintenance window UTC time in hh:mm:ss format
        :param pulumi.Input[_builtins.str] name: Name of the service. The name is used as a prefix for the logical hostname. Must be unique within an account
        :param pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyNetworkArgs', 'ManagedDatabaseValkeyNetworkArgsDict']]]] networks: Private networks attached to the managed database
        :param pulumi.Input[_builtins.str] plan: Service plan to use. This determines how much resources the instance will have. You can list available plans with `upctl database plans valkey`.
        :param pulumi.Input[_builtins.bool] powered: The administrative power state of the service
        :param pulumi.Input[Union['ManagedDatabaseValkeyPropertiesArgs', 'ManagedDatabaseValkeyPropertiesArgsDict']] properties: Database Engine properties for Valkey
        :param pulumi.Input[_builtins.bool] termination_protection: If set to true, prevents the managed service from being powered off, or deleted.
        :param pulumi.Input[_builtins.str] title: Title of a managed database instance
        :param pulumi.Input[_builtins.str] zone: Zone where the instance resides, e.g. `de-fra1`. You can list available zones with `upctl zone list`.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ManagedDatabaseValkeyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ManagedDatabaseValkeyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ManagedDatabaseValkeyArgs.__new__(ManagedDatabaseValkeyArgs)
        ...
        super(ManagedDatabaseValkey, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            additional_disk_space_gib: Optional[pulumi.Input[_builtins.int]] = None,
            components: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyComponentArgs', 'ManagedDatabaseValkeyComponentArgsDict']]]]] = None,
            labels: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            maintenance_window_dow: Optional[pulumi.Input[_builtins.str]] = None,
            maintenance_window_time: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyNetworkArgs', 'ManagedDatabaseValkeyNetworkArgsDict']]]]] = None,
            node_states: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyNodeStateArgs', 'ManagedDatabaseValkeyNodeStateArgsDict']]]]] = None,
            plan: Optional[pulumi.Input[_builtins.str]] = None,
            powered: Optional[pulumi.Input[_builtins.bool]] = None,
            primary_database: Optional[pulumi.Input[_builtins.str]] = None,
            properties: Optional[pulumi.Input[Union['ManagedDatabaseValkeyPropertiesArgs', 'ManagedDatabaseValkeyPropertiesArgsDict']]] = None,
            ...
            title: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            zone: Optional[pulumi.Input[_builtins.str]] = None) -> 'ManagedDatabaseValkey':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.int] additional_disk_space_gib: Not supported for `valkey` databases. Should be left unconfigured.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyComponentArgs', 'ManagedDatabaseValkeyComponentArgsDict']]]] components: Service component information
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] labels: User defined key-value pairs to classify the managed database.
        :param pulumi.Input[_builtins.str] maintenance_window_dow: Maintenance window day of week. Lower case weekday name (monday, tuesday, ...)
        :param pulumi.Input[_builtins.str] maintenance_window_time: Maintenance window UTC time in hh:mm:ss format
        :param pulumi.Input[_builtins.str] name: Name of the service. The name is used as a prefix for the logical hostname. Must be unique within an account
        :param pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyNetworkArgs', 'ManagedDatabaseValkeyNetworkArgsDict']]]] networks: Private networks attached to the managed database
        :param pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseValkeyNodeStateArgs', 'ManagedDatabaseValkeyNodeStateArgsDict']]]] node_states: Information about nodes providing the managed service
        :param pulumi.Input[_builtins.str] plan: Service plan to use. This determines how much resources the instance will have. You can list available plans with `upctl database plans valkey`.
        :param pulumi.Input[_builtins.bool] powered: The administrative power state of the service
        :param pulumi.Input[_builtins.str] primary_database: Primary database name
        :param pulumi.Input[Union['ManagedDatabaseValkeyPropertiesArgs', 'ManagedDatabaseValkeyPropertiesArgsDict']] properties: Database Engine properties for Valkey
        ...
        __props__ = _ManagedDatabaseValkeyState.__new__(_ManagedDatabaseValkeyState)
        ...
        __props__.__dict__["zone"] = zone
        return ManagedDatabaseValkey(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter
    def components(self) -> pulumi.Output[Sequence['outputs.ManagedDatabaseValkeyComponent']]:
        """
        Service component information
        """
        return pulumi.get(self, "components")
    ...
    @_builtins.property
    @pulumi.getter(name="maintenanceWindowDow")
    def maintenance_window_dow(self) -> pulumi.Output[_builtins.str]:
        """
        Maintenance window day of week. Lower case weekday name (monday, tuesday, ...)
        """
        return pulumi.get(self, "maintenance_window_dow")
    ...
    @_builtins.property
    @pulumi.getter(name="maintenanceWindowTime")
    def maintenance_window_time(self) -> pulumi.Output[_builtins.str]:
        """
        Maintenance window UTC time in hh:mm:ss format
        """
        return pulumi.get(self, "maintenance_window_time")
    ...
    @_builtins.property
    @pulumi.getter
    def networks(self) -> pulumi.Output[Optional[Sequence['outputs.ManagedDatabaseValkeyNetwork']]]:
        """
        Private networks attached to the managed database
        """
        return pulumi.get(self, "networks")
    ...
    @_builtins.property
    @pulumi.getter(name="nodeStates")
    def node_states(self) -> pulumi.Output[Sequence['outputs.ManagedDatabaseValkeyNodeState']]:
        """
        Information about nodes providing the managed service
        """
        return pulumi.get(self, "node_states")
    ...
    @_builtins.property
    @pulumi.getter(name="primaryDatabase")
    def primary_database(self) -> pulumi.Output[_builtins.str]:
        """
        Primary database name
        """
        return pulumi.get(self, "primary_database")
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Output['outputs.ManagedDatabaseValkeyProperties']:
        """
        Database Engine properties for Valkey
        """
        return pulumi.get(self, "properties")
    ...
    @_builtins.property
    @pulumi.getter(name="servicePort")
    def service_port(self) -> pulumi.Output[_builtins.str]:
        """
        Port to the service instance
        """
        return pulumi.get(self, "service_port")
