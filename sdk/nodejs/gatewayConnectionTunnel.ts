...
export class GatewayConnectionTunnel extends pulumi.CustomResource {
     ...
     */
    declare public readonly ipsecAuthPsk: pulumi.Output<outputs.GatewayConnectionTunnelIpsecAuthPsk>;
    /**
     * IPsec configuration for the tunnel
     */
    declare public readonly ipsecProperties: pulumi.Output<outputs.GatewayConnectionTunnelIpsecProperties>;
    /**
     * Public (UpCloud) endpoint address of this tunnel
     */
    declare public readonly localAddressName: pulumi.Output<string>;
    /**
