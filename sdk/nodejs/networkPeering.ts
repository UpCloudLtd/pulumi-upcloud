...
export class NetworkPeering extends pulumi.CustomResource {
     ...
     */
    declare public readonly network: pulumi.Output<outputs.NetworkPeeringNetwork>;
    /**
     * Peer network of the network peering.
     */
    declare public readonly peerNetwork: pulumi.Output<outputs.NetworkPeeringPeerNetwork>;
