...
export class LoadbalancerBackend extends pulumi.CustomResource {
    ...
    declare public readonly properties: pulumi.Output<outputs.LoadbalancerBackendProperties | undefined>;
    /**
     * Domain name resolver used with dynamic type members.
     */
    declare public readonly resolverName: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: LoadbalancerBackendArgs | LoadbalancerBackendState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["resolverName"] = state?.resolverName;
            ...
            resourceInputs["resolverName"] = args?.resolverName;
