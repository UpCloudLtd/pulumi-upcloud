 ...
 * ```
 */
export class ManagedDatabaseOpensearch extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedDatabaseOpensearchState, opts?: pulumi.CustomResourceOptions): ManagedDatabaseOpensearch {
        return new ManagedDatabaseOpensearch(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'upcloud:index/managedDatabaseOpensearch:ManagedDatabaseOpensearch';
     ...
     */
    public static isInstance(obj: any): obj is ManagedDatabaseOpensearch {
     ...
     * is enabled.
     */
    public readonly accessControl!: pulumi.Output<boolean>;
    /**
     * Service component information
     */
    public /*out*/ readonly components!: pulumi.Output<outputs.ManagedDatabaseOpensearchComponent[]>;
    /**
     ...
     */
    public readonly networks!: pulumi.Output<outputs.ManagedDatabaseOpensearchNetwork[] | undefined>;
    /**
     * Information about nodes providing the managed service
     */
    public /*out*/ readonly nodeStates!: pulumi.Output<outputs.ManagedDatabaseOpensearchNodeState[]>;
    /**
     ...
     */
    public readonly properties!: pulumi.Output<outputs.ManagedDatabaseOpensearchProperties>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedDatabaseOpensearchArgs | ManagedDatabaseOpensearchState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as ManagedDatabaseOpensearchArgs | undefined;
