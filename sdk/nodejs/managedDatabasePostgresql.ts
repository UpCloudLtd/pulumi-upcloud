 ...
 * ```
 */
export class ManagedDatabasePostgresql extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedDatabasePostgresqlState, opts?: pulumi.CustomResourceOptions): ManagedDatabasePostgresql {
        return new ManagedDatabasePostgresql(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'upcloud:index/managedDatabasePostgresql:ManagedDatabasePostgresql';
     ...
     */
    public static isInstance(obj: any): obj is ManagedDatabasePostgresql {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagedDatabasePostgresql.__pulumiType;
    }
     ...
     */
    declare public readonly networks: pulumi.Output<outputs.ManagedDatabasePostgresqlNetwork[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedDatabasePostgresqlArgs | ManagedDatabasePostgresqlState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ManagedDatabasePostgresql.__pulumiType, name, resourceInputs, opts);
    }
}
