...
export class ManagedObjectStorage extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly endpoints: pulumi.Output<outputs.ManagedObjectStorageEndpoint[]>;
    /**
     ...
     */
    declare public readonly networks: pulumi.Output<outputs.ManagedObjectStorageNetwork[] | undefined>;
    /**
