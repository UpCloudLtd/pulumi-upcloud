...
namespace UpCloud.Pulumi.UpCloud.Inputs
{
    ...
    public sealed class ServerNetworkInterfaceGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _additionalIpAddresses ?? (_additionalIpAddresses = new InputList<Inputs.ServerNetworkInterfaceAdditionalIpAddressGetArgs>());
        ...
        public static new ServerNetworkInterfaceGetArgs Empty => new ServerNetworkInterfaceGetArgs();
    }
}
