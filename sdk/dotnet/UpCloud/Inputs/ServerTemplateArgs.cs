...
namespace UpCloud.Pulumi.UpCloud.Inputs
{
    ...
    public sealed class ServerTemplateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("backupRule")]
        public Input<Inputs.ServerTemplateBackupRuleArgs>? BackupRule { get; set; }
        ...
        public ServerTemplateArgs()
        {
        }
        public static new ServerTemplateArgs Empty => new ServerTemplateArgs();
    }
}
