...
namespace UpCloud.Pulumi.UpCloud.Inputs
{
    ...
    public sealed class GetManagedDatabasePostgresqlSessionsSessionInputArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<string> BackendStart { get; set; } = null!;
        ...
        public Input<int> BackendXid { get; set; } = null!;

        /// <summary>
        /// The current service's xmin horizon.
        /// </summary>
        [Input("backendXmin", required: true)]
        public Input<int> BackendXmin { get; set; } = null!;
        ...
        public Input<string> ClientHostname { get; set; } = null!;
        ...
        public Input<string> QueryDuration { get; set; } = null!;

        /// <summary>
        /// Time when the currently active query was started, or if state is not active, when the last query was started.
        /// </summary>
        [Input("queryStart", required: true)]
        public Input<string> QueryStart { get; set; } = null!;
        ...
        public Input<string> StateChange { get; set; } = null!;

        /// <summary>
        /// Name of the user logged into this service.
        /// </summary>
        [Input("usename", required: true)]
        public Input<string> Usename { get; set; } = null!;

        /// <summary>
        /// OID of the user logged into this service.
        /// </summary>
        [Input("usesysid", required: true)]
        public Input<int> Usesysid { get; set; } = null!;

        /// <summary>
        /// Wait event name if service is currently waiting.
        /// </summary>
        [Input("waitEvent", required: true)]
        public Input<string> WaitEvent { get; set; } = null!;

        /// <summary>
        /// The type of event for which the service is waiting, if any; otherwise NULL.
        /// </summary>
        [Input("waitEventType", required: true)]
        public Input<string> WaitEventType { get; set; } = null!;

        /// <summary>
        /// Time when this process' current transaction was started, or null if no transaction is active.
        /// </summary>
        [Input("xactStart", required: true)]
        public Input<string> XactStart { get; set; } = null!;

        public GetManagedDatabasePostgresqlSessionsSessionInputArgs()
        {
        }
        public static new GetManagedDatabasePostgresqlSessionsSessionInputArgs Empty => new GetManagedDatabasePostgresqlSessionsSessionInputArgs();
    }
}
