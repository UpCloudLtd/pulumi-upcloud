...
namespace Pulumi.Upcloud
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/UpCloudLtd/pulumi-upcloud/releases/download/${VERSION}/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Upcloud.version.txt");
    ...
    internal sealed class UpcloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public UpcloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
