...
public final class ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs Empty = new ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs();
    ...
    /**
     * @return The window of time in which the value for `allowedTries` is enforced.
     * 
     */
    ...
    private ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs() {}

    private ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs(ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs $) {
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs();
        }

        public Builder(ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs defaults) {
            $ = new ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param authenticationBackend The internal backend. Enter `internal`.
         * 
         * @return builder
         * 
         */
        public Builder authenticationBackend(@Nullable Output<String> authenticationBackend) {
         ...
         * 
         */
        public Builder authenticationBackend(String authenticationBackend) {
            return authenticationBackend(Output.of(authenticationBackend));
        }
        ...
        /**
         * @param timeWindowSeconds The window of time in which the value for `allowedTries` is enforced.
         * 
         * @return builder
         * 
         */
        ...
        public ManagedDatabaseOpensearchPropertiesAuthFailureListenersInternalAuthenticationBackendLimitingArgs build() {
            return $;
        }
    }
