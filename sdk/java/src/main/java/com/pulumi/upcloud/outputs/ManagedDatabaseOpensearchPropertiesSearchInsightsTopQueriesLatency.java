...
@CustomType
public final class ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesLatency {
    /**
    ...
    private ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesLatency() {}
    /**
     * @return Enable or disable top N query monitoring by the metric. Enable or disable top N query monitoring by the metric.
     * 
     */
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesLatency defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String windowSize;
        public Builder() {}
        public Builder(ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesLatency defaults) {
        ...
        public ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesLatency build() {
            final var _resultValue = new ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesLatency();
