...
@CustomType
public final class LoadbalancerFrontendRuleMatchersUrlParam {
    /**
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersUrlParam defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(LoadbalancerFrontendRuleMatchersUrlParam defaults) {
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersUrlParam", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersUrlParam", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public LoadbalancerFrontendRuleMatchersUrlParam build() {
            final var _resultValue = new LoadbalancerFrontendRuleMatchersUrlParam();
