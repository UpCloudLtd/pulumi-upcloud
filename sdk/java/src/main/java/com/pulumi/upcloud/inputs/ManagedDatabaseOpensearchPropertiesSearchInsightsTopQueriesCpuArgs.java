...
public final class ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs Empty = new ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs();
    ...
    private ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs() {}

    private ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs(ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs $) {
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs();
        }

        public Builder(ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs defaults) {
            $ = new ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpuArgs build() {
            return $;
        }
    }
