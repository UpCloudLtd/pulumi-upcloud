...
public final class LoadbalancerFrontendRuleMatchersHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerFrontendRuleMatchersHeaderArgs Empty = new LoadbalancerFrontendRuleMatchersHeaderArgs();
    ...
    private LoadbalancerFrontendRuleMatchersHeaderArgs() {}

    private LoadbalancerFrontendRuleMatchersHeaderArgs(LoadbalancerFrontendRuleMatchersHeaderArgs $) {
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerFrontendRuleMatchersHeaderArgs();
        }

        public Builder(LoadbalancerFrontendRuleMatchersHeaderArgs defaults) {
            $ = new LoadbalancerFrontendRuleMatchersHeaderArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoadbalancerFrontendRuleMatchersHeaderArgs build() {
            if ($.method == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersHeaderArgs", "method");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersHeaderArgs", "name");
            }
            return $;
        }
    }
