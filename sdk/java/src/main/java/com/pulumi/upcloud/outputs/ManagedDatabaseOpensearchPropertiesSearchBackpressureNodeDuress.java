...
@CustomType
public final class ManagedDatabaseOpensearchPropertiesSearchBackpressureNodeDuress {
    /**
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesSearchBackpressureNodeDuress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer numSuccessiveBreaches;
        public Builder() {}
        public Builder(ManagedDatabaseOpensearchPropertiesSearchBackpressureNodeDuress defaults) {
        ...
        public ManagedDatabaseOpensearchPropertiesSearchBackpressureNodeDuress build() {
            final var _resultValue = new ManagedDatabaseOpensearchPropertiesSearchBackpressureNodeDuress();
