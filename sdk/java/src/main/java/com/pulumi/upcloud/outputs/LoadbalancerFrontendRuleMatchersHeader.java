...
@CustomType
public final class LoadbalancerFrontendRuleMatchersHeader {
    /**
    ...
    private LoadbalancerFrontendRuleMatchersHeader() {}
    /**
     * @return Defines if case should be ignored. Defaults to `false`.
     * 
     */
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(LoadbalancerFrontendRuleMatchersHeader defaults) {
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersHeader", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public LoadbalancerFrontendRuleMatchersHeader build() {
            final var _resultValue = new LoadbalancerFrontendRuleMatchersHeader();
