...
@CustomType
public final class LoadbalancerFrontendRuleMatchersUrl {
    /**
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersUrl defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(LoadbalancerFrontendRuleMatchersUrl defaults) {
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersUrl", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public LoadbalancerFrontendRuleMatchersUrl build() {
            final var _resultValue = new LoadbalancerFrontendRuleMatchersUrl();
