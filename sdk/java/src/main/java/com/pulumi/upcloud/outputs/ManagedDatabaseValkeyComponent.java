...
public final class ManagedDatabaseValkeyComponent {
    ...
    public static Builder builder(ManagedDatabaseValkeyComponent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String usage;
        public Builder() {}
        public Builder(ManagedDatabaseValkeyComponent defaults) {
        ...
        public ManagedDatabaseValkeyComponent build() {
            final var _resultValue = new ManagedDatabaseValkeyComponent();
