...
public final class ServerTemplateArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The device address the storage will be attached to (`scsi`|`virtio`|`ide`). Leave `addressPosition` field empty to auto-select next available address from that bus.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param address The device address the storage will be attached to (`scsi`|`virtio`|`ide`). Leave `addressPosition` field empty to auto-select next available address from that bus.
         * 
         * @return builder
         * 
         */
