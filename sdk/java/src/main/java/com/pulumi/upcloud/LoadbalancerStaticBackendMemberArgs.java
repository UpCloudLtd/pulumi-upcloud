...
public final class LoadbalancerStaticBackendMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerStaticBackendMemberArgs Empty = new LoadbalancerStaticBackendMemberArgs();
    ...
    private LoadbalancerStaticBackendMemberArgs() {}

    private LoadbalancerStaticBackendMemberArgs(LoadbalancerStaticBackendMemberArgs $) {
    ...
    public static Builder builder(LoadbalancerStaticBackendMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerStaticBackendMemberArgs();
        }

        public Builder(LoadbalancerStaticBackendMemberArgs defaults) {
            $ = new LoadbalancerStaticBackendMemberArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoadbalancerStaticBackendMemberArgs build() {
            if ($.backend == null) {
                throw new MissingRequiredPropertyException("LoadbalancerStaticBackendMemberArgs", "backend");
            }
            if ($.maxSessions == null) {
                throw new MissingRequiredPropertyException("LoadbalancerStaticBackendMemberArgs", "maxSessions");
            }
            if ($.weight == null) {
                throw new MissingRequiredPropertyException("LoadbalancerStaticBackendMemberArgs", "weight");
            }
            return $;
        }
    }
