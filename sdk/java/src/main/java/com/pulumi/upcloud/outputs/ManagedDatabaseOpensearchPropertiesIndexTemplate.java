...
public final class ManagedDatabaseOpensearchPropertiesIndexTemplate {
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesIndexTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer numberOfShards;
        public Builder() {}
        public Builder(ManagedDatabaseOpensearchPropertiesIndexTemplate defaults) {
        ...
        public ManagedDatabaseOpensearchPropertiesIndexTemplate build() {
            final var _resultValue = new ManagedDatabaseOpensearchPropertiesIndexTemplate();
