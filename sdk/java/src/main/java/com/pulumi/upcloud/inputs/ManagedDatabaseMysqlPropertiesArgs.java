...
public final class ManagedDatabaseMysqlPropertiesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param binlogRetentionPeriod The minimum amount of time in seconds to keep binlog entries before deletion. This may be extended for services that require binlog entries for longer than the default for example if using the MySQL Debezium Kafka connector. Warning: reducing this value can make a large batch of binary logs eligible for purge at once. Depending on the volume, this can sometimes stall the MySQL commit path and block writes until the purge completes. To stay on the safe side, prefer lowering the value gradually in small decrements during a low-traffic window rather than dropping it drastically in one step.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param logOutput The slow log output destination when slowQueryLog is ON. To enable MySQL AI Insights, choose INSIGHTS. To use MySQL AI Insights and the mysql.slow_log table at the same time, choose INSIGHTS,TABLE. To only use the mysql.slow_log table, choose TABLE. To silence slow logs, choose NONE.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param longQueryTime The slowQueryLogs work as SQL statements that take more than longQueryTime seconds to execute.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param slowQueryLog Slow query log enables capturing of slow queries. Setting slowQueryLog to false also truncates the mysql.slow_log table.
         * 
         * @return builder
         * 
         */
