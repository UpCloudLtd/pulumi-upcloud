...
public final class LoadbalancerFrontendRuleMatchersCookieArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerFrontendRuleMatchersCookieArgs Empty = new LoadbalancerFrontendRuleMatchersCookieArgs();
    ...
    private LoadbalancerFrontendRuleMatchersCookieArgs() {}

    private LoadbalancerFrontendRuleMatchersCookieArgs(LoadbalancerFrontendRuleMatchersCookieArgs $) {
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersCookieArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerFrontendRuleMatchersCookieArgs();
        }

        public Builder(LoadbalancerFrontendRuleMatchersCookieArgs defaults) {
            $ = new LoadbalancerFrontendRuleMatchersCookieArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoadbalancerFrontendRuleMatchersCookieArgs build() {
            if ($.method == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersCookieArgs", "method");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersCookieArgs", "name");
            }
            return $;
        }
    }
