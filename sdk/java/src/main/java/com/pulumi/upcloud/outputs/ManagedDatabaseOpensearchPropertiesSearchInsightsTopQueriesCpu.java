...
@CustomType
public final class ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpu {
    /**
    ...
    private ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpu() {}
    /**
     * @return Enable or disable top N query monitoring by the metric. Enable or disable top N query monitoring by the metric.
     * 
     */
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpu defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String windowSize;
        public Builder() {}
        public Builder(ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpu defaults) {
        ...
        public ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpu build() {
            final var _resultValue = new ManagedDatabaseOpensearchPropertiesSearchInsightsTopQueriesCpu();
