...
public final class StorageImportArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param source The mode of the import task. One of `httpImport` or `directUpload`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param sourceLocation The location of the file to import. For `httpImport` an accessible URL. For `directUpload` a local file. When direct uploading a compressed image, `Content-Type` header of the PUT request is set automatically based on the file extension (`.gz` or `.xz`, case-insensitive).
         * 
         * @return builder
         * 
         */
