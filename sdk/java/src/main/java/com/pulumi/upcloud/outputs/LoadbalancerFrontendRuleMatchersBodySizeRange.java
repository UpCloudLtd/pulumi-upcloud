...
@CustomType
public final class LoadbalancerFrontendRuleMatchersBodySizeRange {
    /**
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersBodySizeRange defaults) {
    ...
    public static final class Builder {
        ...
        private Integer rangeStart;
        public Builder() {}
        public Builder(LoadbalancerFrontendRuleMatchersBodySizeRange defaults) {
        ...
        public Builder rangeEnd(Integer rangeEnd) {
            if (rangeEnd == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersBodySizeRange", "rangeEnd");
            }
        ...
        public Builder rangeStart(Integer rangeStart) {
            if (rangeStart == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersBodySizeRange", "rangeStart");
            }
            this.rangeStart = rangeStart;
            return this;
        }
        public LoadbalancerFrontendRuleMatchersBodySizeRange build() {
            final var _resultValue = new LoadbalancerFrontendRuleMatchersBodySizeRange();
