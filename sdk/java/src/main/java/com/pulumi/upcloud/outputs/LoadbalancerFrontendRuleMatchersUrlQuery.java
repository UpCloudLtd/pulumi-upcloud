...
@CustomType
public final class LoadbalancerFrontendRuleMatchersUrlQuery {
    /**
    ...
    private LoadbalancerFrontendRuleMatchersUrlQuery() {}
    /**
     * @return Defines if case should be ignored. Defaults to `false`.
     * 
     */
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersUrlQuery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(LoadbalancerFrontendRuleMatchersUrlQuery defaults) {
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersUrlQuery", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public LoadbalancerFrontendRuleMatchersUrlQuery build() {
            final var _resultValue = new LoadbalancerFrontendRuleMatchersUrlQuery();
