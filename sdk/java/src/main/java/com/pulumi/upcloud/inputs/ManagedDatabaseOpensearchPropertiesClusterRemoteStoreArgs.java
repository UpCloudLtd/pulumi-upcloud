...
public final class ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs Empty = new ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs();
    ...
    /**
     * @return The amount of time to wait for the cluster state upload to complete. The amount of time to wait for the cluster state upload to complete. Defaults to 20s.
     * 
     */
    ...
    /**
     * @return The default value of the translog buffer interval. The default value of the translog buffer interval used when performing periodic translog updates. This setting is only effective when the index setting `index.remote_store.translog.buffer_interval` is not present. Defaults to 650ms.
     * 
     */
    ...
    /**
     * @return The maximum number of open translog files for remote-backed indexes. Sets the maximum number of open translog files for remote-backed indexes. This limits the total number of translog files per shard. After reaching this limit, the remote store flushes the translog files. Default is 1000. The minimum required is 100.
     * 
     */
    ...
    private ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs() {}

    private ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs(ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs $) {
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs();
        }

        public Builder(ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs defaults) {
            $ = new ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param stateGlobalMetadataUploadTimeout The amount of time to wait for the cluster state upload to complete. The amount of time to wait for the cluster state upload to complete. Defaults to 20s.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param stateMetadataManifestUploadTimeout The amount of time to wait for the manifest file upload to complete. The amount of time to wait for the manifest file upload to complete. The manifest file contains the details of each of the files uploaded for a single cluster state, both index metadata files and global metadata files. Defaults to 20s.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param translogBufferInterval The default value of the translog buffer interval. The default value of the translog buffer interval used when performing periodic translog updates. This setting is only effective when the index setting `index.remote_store.translog.buffer_interval` is not present. Defaults to 650ms.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param translogMaxReaders The maximum number of open translog files for remote-backed indexes. Sets the maximum number of open translog files for remote-backed indexes. This limits the total number of translog files per shard. After reaching this limit, the remote store flushes the translog files. Default is 1000. The minimum required is 100.
         * 
         * @return builder
         * 
         */
        ...
        public ManagedDatabaseOpensearchPropertiesClusterRemoteStoreArgs build() {
            return $;
        }
    }
