...
public final class RouterState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return A collection of static routes for this router. This set includes both user and service defined static routes. The objects in this set use the same schema as `staticRoute` blocks.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param staticRoutes A collection of static routes for this router. This set includes both user and service defined static routes. The objects in this set use the same schema as `staticRoute` blocks.
         * 
         * @return builder
         * 
         */
