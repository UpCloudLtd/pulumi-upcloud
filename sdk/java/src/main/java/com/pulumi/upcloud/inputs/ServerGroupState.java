...
public final class ServerGroupState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return UUIDs of the servers that are members of this group. Servers can also be attached to the server group via `serverGroup` property of `upcloud.Server`. See also `trackMembers` property.
     * 
     */
    ...
    /**
     * @return Controls if members of the server group are being tracked in this resource. Set to `false` when using `serverGroup` property of `upcloud.Server` to attach servers to the server group to avoid delayed state updates.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param antiAffinityPolicy Defines if a server group is an anti-affinity group. Setting this to `strict` or `yes` will
         * 	result in all servers in the group being placed on separate compute hosts. The value can be `strict`, `yes`, or `no`.
         * 
         *     * `strict` policy doesn&#39;t allow servers in the same server group to be on the same host
         *     * `yes` refers to best-effort policy and tries to put servers on different hosts, but this is not guaranteed
        ...
        /**
         * @param members UUIDs of the servers that are members of this group. Servers can also be attached to the server group via `serverGroup` property of `upcloud.Server`. See also `trackMembers` property.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param trackMembers Controls if members of the server group are being tracked in this resource. Set to `false` when using `serverGroup` property of `upcloud.Server` to attach servers to the server group to avoid delayed state updates.
         * 
         * @return builder
         * 
         */
