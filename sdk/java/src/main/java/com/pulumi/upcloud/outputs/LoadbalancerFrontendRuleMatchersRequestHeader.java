...
@CustomType
public final class LoadbalancerFrontendRuleMatchersRequestHeader {
    /**
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersRequestHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(LoadbalancerFrontendRuleMatchersRequestHeader defaults) {
        ...
        public Builder method(String method) {
            if (method == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersRequestHeader", "method");
            }
            this.method = method;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersRequestHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public LoadbalancerFrontendRuleMatchersRequestHeader build() {
            final var _resultValue = new LoadbalancerFrontendRuleMatchersRequestHeader();
