...
public final class LoadbalancerBackendPropertiesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Expected HTTP status code returned by the customer application to mark server as healthy. Ignored for `tcp` `healthCheckType`.
     * 
     */
    ...
    /**
     * @return Target path for health check HTTP GET requests. Ignored for `tcp` `healthCheckType`.
     * 
     */
    ...
    /**
     * @return Allow HTTP/2 connections to backend members by utilizing ALPN extension of TLS protocol, therefore it can only be enabled when tlsEnabled is set to true. Note: members should support HTTP/2 for this setting to work.
     * 
     */
    ...
    /**
     * @return Enables backend servers certificate verification. Please make sure that TLS config with the certificate bundle of type authority attached to the backend or `tlsUseSystemCa` enabled. Note: `tlsVerify` has preference over `healthCheckTlsVerify` when `tlsEnabled` in true.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param healthCheckExpectedStatus Expected HTTP status code returned by the customer application to mark server as healthy. Ignored for `tcp` `healthCheckType`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param healthCheckUrl Target path for health check HTTP GET requests. Ignored for `tcp` `healthCheckType`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param http2Enabled Allow HTTP/2 connections to backend members by utilizing ALPN extension of TLS protocol, therefore it can only be enabled when tlsEnabled is set to true. Note: members should support HTTP/2 for this setting to work.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tlsVerify Enables backend servers certificate verification. Please make sure that TLS config with the certificate bundle of type authority attached to the backend or `tlsUseSystemCa` enabled. Note: `tlsVerify` has preference over `healthCheckTlsVerify` when `tlsEnabled` in true.
         * 
         * @return builder
         * 
         */
