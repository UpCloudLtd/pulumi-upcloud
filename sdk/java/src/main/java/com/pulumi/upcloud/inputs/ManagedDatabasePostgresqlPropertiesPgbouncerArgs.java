...
public final class ManagedDatabasePostgresqlPropertiesPgbouncerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return PgBouncer tracks protocol-level named prepared statements related commands sent by the client in transaction and statement pooling modes when maxPreparedStatements is set to a non-zero value. Setting it to 0 disables prepared statements. maxPreparedStatements defaults to 100, and its maximum is 3000.
     * 
     */
    ...
    /**
     * @return Run serverResetQuery (DISCARD ALL) in all pooling modes.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param maxPreparedStatements PgBouncer tracks protocol-level named prepared statements related commands sent by the client in transaction and statement pooling modes when maxPreparedStatements is set to a non-zero value. Setting it to 0 disables prepared statements. maxPreparedStatements defaults to 100, and its maximum is 3000.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serverResetQueryAlways Run serverResetQuery (DISCARD ALL) in all pooling modes.
         * 
         * @return builder
         * 
         */
