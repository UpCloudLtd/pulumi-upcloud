...
public final class LoadbalancerDynamicBackendMemberArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerDynamicBackendMemberArgs Empty = new LoadbalancerDynamicBackendMemberArgs();
     ...
     * 
     */
    @Import(name="maxSessions", required=true)
    ...
    private LoadbalancerDynamicBackendMemberArgs() {}

    private LoadbalancerDynamicBackendMemberArgs(LoadbalancerDynamicBackendMemberArgs $) {
    ...
    public static Builder builder(LoadbalancerDynamicBackendMemberArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerDynamicBackendMemberArgs();
        }

        public Builder(LoadbalancerDynamicBackendMemberArgs defaults) {
            $ = new LoadbalancerDynamicBackendMemberArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder maxSessions(Output<Integer> maxSessions) {
        ...
        public LoadbalancerDynamicBackendMemberArgs build() {
            if ($.backend == null) {
                throw new MissingRequiredPropertyException("LoadbalancerDynamicBackendMemberArgs", "backend");
            }
            if ($.maxSessions == null) {
                throw new MissingRequiredPropertyException("LoadbalancerDynamicBackendMemberArgs", "maxSessions");
            }
            if ($.weight == null) {
                throw new MissingRequiredPropertyException("LoadbalancerDynamicBackendMemberArgs", "weight");
            }
            return $;
        }
    }
