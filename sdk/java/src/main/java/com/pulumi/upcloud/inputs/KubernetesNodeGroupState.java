...
public final class KubernetesNodeGroupState extends com.pulumi.resources.ResourceArgs {

    public static final KubernetesNodeGroupState Empty = new KubernetesNodeGroupState();
    ...
    private KubernetesNodeGroupState() {}
    ...
    public static Builder builder(KubernetesNodeGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubernetesNodeGroupState();
        }

        public Builder(KubernetesNodeGroupState defaults) {
            $ = new KubernetesNodeGroupState(Objects.requireNonNull(defaults));
        }
        ...
        public KubernetesNodeGroupState build() {
            return $;
        }
    }
