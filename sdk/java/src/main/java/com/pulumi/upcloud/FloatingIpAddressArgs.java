...
public final class FloatingIpAddressArgs extends com.pulumi.resources.ResourceArgs {

    public static final FloatingIpAddressArgs Empty = new FloatingIpAddressArgs();
    ...
    private FloatingIpAddressArgs() {}

    private FloatingIpAddressArgs(FloatingIpAddressArgs $) {
        this.access = $.access;
        this.family = $.family;
    ...
    public static Builder builder(FloatingIpAddressArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FloatingIpAddressArgs();
        }

        public Builder(FloatingIpAddressArgs defaults) {
            $ = new FloatingIpAddressArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FloatingIpAddressArgs build() {
            return $;
        }
    }
