...
public final class LoadbalancerFrontendRuleMatchersPathArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerFrontendRuleMatchersPathArgs Empty = new LoadbalancerFrontendRuleMatchersPathArgs();
    ...
    private LoadbalancerFrontendRuleMatchersPathArgs() {}

    private LoadbalancerFrontendRuleMatchersPathArgs(LoadbalancerFrontendRuleMatchersPathArgs $) {
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersPathArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerFrontendRuleMatchersPathArgs();
        }

        public Builder(LoadbalancerFrontendRuleMatchersPathArgs defaults) {
            $ = new LoadbalancerFrontendRuleMatchersPathArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoadbalancerFrontendRuleMatchersPathArgs build() {
            if ($.method == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersPathArgs", "method");
            }
            return $;
        }
    }
