...
public final class ManagedDatabaseOpensearchPropertiesSegrepArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedDatabaseOpensearchPropertiesSegrepArgs Empty = new ManagedDatabaseOpensearchPropertiesSegrepArgs();
    ...
    /**
     * @return The maximum number of indexing checkpoints that a replica shard can fall behind when copying from primary. Once `segrep.pressure.checkpoint.limit` is breached along with `segrep.pressure.time.limit`, the segment replication backpressure mechanism is initiated. Default is 4 checkpoints.
     * 
     */
    ...
    /**
     * @return Enables the segment replication backpressure mechanism. Default is false.
     * 
     */
    ...
    /**
     * @return The maximum number of stale replica shards that can exist in a replication group. Once `segrep.pressure.replica.stale.limit` is breached, the segment replication backpressure mechanism is initiated. Default is .5, which is 50% of a replication group.
     * 
     */
    ...
    /**
     * @return The maximum amount of time that a replica shard can take to copy from the primary shard. Once segrep.pressure.time.limit is breached along with segrep.pressure.checkpoint.limit, the segment replication backpressure mechanism is initiated. Default is 5 minutes.
     * 
     */
    ...
    private ManagedDatabaseOpensearchPropertiesSegrepArgs() {}

    private ManagedDatabaseOpensearchPropertiesSegrepArgs(ManagedDatabaseOpensearchPropertiesSegrepArgs $) {
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesSegrepArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedDatabaseOpensearchPropertiesSegrepArgs();
        }

        public Builder(ManagedDatabaseOpensearchPropertiesSegrepArgs defaults) {
            $ = new ManagedDatabaseOpensearchPropertiesSegrepArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param pressureCheckpointLimit The maximum number of indexing checkpoints that a replica shard can fall behind when copying from primary. Once `segrep.pressure.checkpoint.limit` is breached along with `segrep.pressure.time.limit`, the segment replication backpressure mechanism is initiated. Default is 4 checkpoints.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param pressureEnabled Enables the segment replication backpressure mechanism. Default is false.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param pressureReplicaStaleLimit The maximum number of stale replica shards that can exist in a replication group. Once `segrep.pressure.replica.stale.limit` is breached, the segment replication backpressure mechanism is initiated. Default is .5, which is 50% of a replication group.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param pressureTimeLimit The maximum amount of time that a replica shard can take to copy from the primary shard. Once segrep.pressure.time.limit is breached along with segrep.pressure.checkpoint.limit, the segment replication backpressure mechanism is initiated. Default is 5 minutes.
         * 
         * @return builder
         * 
         */
        ...
        public ManagedDatabaseOpensearchPropertiesSegrepArgs build() {
            return $;
        }
    }
