...
public final class LoadbalancerFrontendRuleMatchersResponseHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerFrontendRuleMatchersResponseHeaderArgs Empty = new LoadbalancerFrontendRuleMatchersResponseHeaderArgs();
    ...
    private LoadbalancerFrontendRuleMatchersResponseHeaderArgs() {}

    private LoadbalancerFrontendRuleMatchersResponseHeaderArgs(LoadbalancerFrontendRuleMatchersResponseHeaderArgs $) {
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersResponseHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerFrontendRuleMatchersResponseHeaderArgs();
        }

        public Builder(LoadbalancerFrontendRuleMatchersResponseHeaderArgs defaults) {
            $ = new LoadbalancerFrontendRuleMatchersResponseHeaderArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param method Match method (`exact`, `substring`, `regexp`, `starts`, `ends`, `domain`, `ip`, `exists`). Matcher with `exists` and `ip` methods must be used without `value` and `ignoreCase` fields.
         * 
         * @return builder
         * 
         */
        ...
        public LoadbalancerFrontendRuleMatchersResponseHeaderArgs build() {
            if ($.method == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersResponseHeaderArgs", "method");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersResponseHeaderArgs", "name");
            }
            return $;
        }
    }
