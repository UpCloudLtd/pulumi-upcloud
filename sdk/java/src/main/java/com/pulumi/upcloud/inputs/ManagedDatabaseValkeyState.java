...
import com.pulumi.upcloud.inputs.ManagedDatabaseValkeyComponentArgs;
import com.pulumi.upcloud.inputs.ManagedDatabaseValkeyNetworkArgs;
import com.pulumi.upcloud.inputs.ManagedDatabaseValkeyNodeStateArgs;
...
public final class ManagedDatabaseValkeyState extends com.pulumi.resources.ResourceArgs {

    public static final ManagedDatabaseValkeyState Empty = new ManagedDatabaseValkeyState();
    ...
    private @Nullable Output<List<ManagedDatabaseValkeyComponentArgs>> components;

    /**
     * @return Service component information
     * 
     */
    public Optional<Output<List<ManagedDatabaseValkeyComponentArgs>>> components() {
    ...
    private @Nullable Output<List<ManagedDatabaseValkeyNetworkArgs>> networks;

    /**
     * @return Private networks attached to the managed database
     * 
     */
    public Optional<Output<List<ManagedDatabaseValkeyNetworkArgs>>> networks() {
    ...
    private @Nullable Output<List<ManagedDatabaseValkeyNodeStateArgs>> nodeStates;

    /**
     * @return Information about nodes providing the managed service
     * 
     */
    public Optional<Output<List<ManagedDatabaseValkeyNodeStateArgs>>> nodeStates() {
    ...
    private @Nullable Output<ManagedDatabaseValkeyPropertiesArgs> properties;

    /**
     * @return Database Engine properties for Valkey
     * 
     */
    public Optional<Output<ManagedDatabaseValkeyPropertiesArgs>> properties() {
    ...
    private ManagedDatabaseValkeyState() {}

    private ManagedDatabaseValkeyState(ManagedDatabaseValkeyState $) {
    ...
    public static Builder builder(ManagedDatabaseValkeyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedDatabaseValkeyState();
        }

        public Builder(ManagedDatabaseValkeyState defaults) {
            $ = new ManagedDatabaseValkeyState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder components(@Nullable Output<List<ManagedDatabaseValkeyComponentArgs>> components) {
         ...
         * 
         */
        public Builder components(List<ManagedDatabaseValkeyComponentArgs> components) {
         ...
         * 
         */
        public Builder components(ManagedDatabaseValkeyComponentArgs... components) {
         ...
         * 
         */
        public Builder networks(@Nullable Output<List<ManagedDatabaseValkeyNetworkArgs>> networks) {
            $.networks = networks;
            return this;
        }
         ...
         * 
         */
        public Builder networks(List<ManagedDatabaseValkeyNetworkArgs> networks) {
         ...
         * 
         */
        public Builder networks(ManagedDatabaseValkeyNetworkArgs... networks) {
         ...
         * 
         */
        public Builder nodeStates(@Nullable Output<List<ManagedDatabaseValkeyNodeStateArgs>> nodeStates) {
         ...
         * 
         */
        public Builder nodeStates(List<ManagedDatabaseValkeyNodeStateArgs> nodeStates) {
         ...
         * 
         */
        public Builder nodeStates(ManagedDatabaseValkeyNodeStateArgs... nodeStates) {
        ...
        /**
         * @param properties Database Engine properties for Valkey
         * 
         * @return builder
         * 
         */
        public Builder properties(@Nullable Output<ManagedDatabaseValkeyPropertiesArgs> properties) {
         ...
         * 
         */
        public Builder properties(ManagedDatabaseValkeyPropertiesArgs properties) {
        ...
        public ManagedDatabaseValkeyState build() {
            return $;
        }
    }
