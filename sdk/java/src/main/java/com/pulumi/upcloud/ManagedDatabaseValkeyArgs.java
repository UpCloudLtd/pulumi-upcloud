...
public final class ManagedDatabaseValkeyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ManagedDatabaseValkeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public ManagedDatabaseValkeyArgs build() {
            if ($.plan == null) {
                throw new MissingRequiredPropertyException("ManagedDatabaseValkeyArgs", "plan");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("ManagedDatabaseValkeyArgs", "title");
            }
            if ($.zone == null) {
                throw new MissingRequiredPropertyException("ManagedDatabaseValkeyArgs", "zone");
            }
            return $;
        }
    }
