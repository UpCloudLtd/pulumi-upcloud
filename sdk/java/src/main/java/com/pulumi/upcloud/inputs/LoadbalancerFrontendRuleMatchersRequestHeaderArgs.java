...
public final class LoadbalancerFrontendRuleMatchersRequestHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final LoadbalancerFrontendRuleMatchersRequestHeaderArgs Empty = new LoadbalancerFrontendRuleMatchersRequestHeaderArgs();
    ...
    private LoadbalancerFrontendRuleMatchersRequestHeaderArgs() {}

    private LoadbalancerFrontendRuleMatchersRequestHeaderArgs(LoadbalancerFrontendRuleMatchersRequestHeaderArgs $) {
    ...
    public static Builder builder(LoadbalancerFrontendRuleMatchersRequestHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoadbalancerFrontendRuleMatchersRequestHeaderArgs();
        }

        public Builder(LoadbalancerFrontendRuleMatchersRequestHeaderArgs defaults) {
            $ = new LoadbalancerFrontendRuleMatchersRequestHeaderArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LoadbalancerFrontendRuleMatchersRequestHeaderArgs build() {
            if ($.method == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersRequestHeaderArgs", "method");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LoadbalancerFrontendRuleMatchersRequestHeaderArgs", "name");
            }
            return $;
        }
    }
