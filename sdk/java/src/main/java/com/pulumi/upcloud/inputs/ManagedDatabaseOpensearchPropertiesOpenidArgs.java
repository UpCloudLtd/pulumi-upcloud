...
public final class ManagedDatabaseOpensearchPropertiesOpenidArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedDatabaseOpensearchPropertiesOpenidArgs Empty = new ManagedDatabaseOpensearchPropertiesOpenidArgs();
     ...
     * 
     */
    @Import(name="connectUrl")
    private @Nullable Output<String> connectUrl;
     ...
     * 
     */
    public Optional<Output<String>> connectUrl() {
    ...
    /**
     * @return The key in the JSON payload that stores the user’s name. The key in the JSON payload that stores the user’s name. If not defined, the subject registered claim is used. Most IdP providers use the preferredUsername claim. Optional.
     * 
     */
    ...
    private ManagedDatabaseOpensearchPropertiesOpenidArgs() {}

    private ManagedDatabaseOpensearchPropertiesOpenidArgs(ManagedDatabaseOpensearchPropertiesOpenidArgs $) {
    ...
    public static Builder builder(ManagedDatabaseOpensearchPropertiesOpenidArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedDatabaseOpensearchPropertiesOpenidArgs();
        }

        public Builder(ManagedDatabaseOpensearchPropertiesOpenidArgs defaults) {
            $ = new ManagedDatabaseOpensearchPropertiesOpenidArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param clientId The ID of the OpenID Connect client. The ID of the OpenID Connect client configured in your IdP. Required.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param clientSecret The client secret of the OpenID Connect. The client secret of the OpenID Connect client configured in your IdP. Required.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param connectUrl OpenID Connect metadata/configuration URL. The URL of your IdP where the Security plugin can find the OpenID Connect metadata/configuration settings.
         * 
         * @return builder
         * 
         */
        public Builder connectUrl(@Nullable Output<String> connectUrl) {
        ...
        /**
         * @param enabled Enable or disable OpenSearch OpenID Connect authentication. Enables or disables OpenID Connect authentication for OpenSearch. When enabled, users can authenticate using OpenID Connect with an Identity Provider.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param header HTTP header name of the JWT token. HTTP header name of the JWT token. Optional. Default is Authorization.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param jwtHeader The HTTP header that stores the token. The HTTP header that stores the token. Typically the Authorization header with the Bearer schema: Authorization: Bearer &lt;token&gt;. Optional. Default is Authorization.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param jwtUrlParameter URL JWT token. If the token is not transmitted in the HTTP header, but as an URL parameter, define the name of the parameter here. Optional.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param refreshRateLimitCount The maximum number of unknown key IDs in the time frame. The maximum number of unknown key IDs in the time frame. Default is 10. Optional.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param refreshRateLimitTimeWindowMs The time frame to use when checking the maximum number of unknown key IDs, in milliseconds. The time frame to use when checking the maximum number of unknown key IDs, in milliseconds. Optional.Default is 10000 (10 seconds).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param rolesKey The key in the JSON payload that stores the user’s roles. The key in the JSON payload that stores the user’s roles. The value of this key must be a comma-separated list of roles. Required only if you want to use roles in the JWT.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param scope The scope of the identity token issued by the IdP. The scope of the identity token issued by the IdP. Optional. Default is openid profile email address phone.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param subjectKey The key in the JSON payload that stores the user’s name. The key in the JSON payload that stores the user’s name. If not defined, the subject registered claim is used. Most IdP providers use the preferredUsername claim. Optional.
         * 
         * @return builder
         * 
         */
        ...
        public ManagedDatabaseOpensearchPropertiesOpenidArgs build() {
            return $;
        }
    }
