...
type ServerGroup struct {
	...
	// UUIDs of the servers that are members of this group. Servers can also be attached to the server group via `serverGroup` property of `Server`. See also `trackMembers` property.
	Members pulumi.StringArrayOutput `pulumi:"members"`
	// Title of your server group
	Title pulumi.StringOutput `pulumi:"title"`
	// Controls if members of the server group are being tracked in this resource. Set to `false` when using `serverGroup` property of `Server` to attach servers to the server group to avoid delayed state updates.
